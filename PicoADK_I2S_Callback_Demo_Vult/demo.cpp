...
void Demo__ctx_type_5_init(Demo__ctx_type_5 &_output_){
   ...
   Demo__ctx_type_3_init(_ctx._inst1f1);
...
void Demo__ctx_type_6_init(Demo__ctx_type_6 &_output_){
   ...
   Demo__ctx_type_5_init(_ctx._inst127);
   Demo_sineInit(_ctx);
   _output_ = _ctx;
   return ;
}
...
void Demo__ctx_type_7_init(Demo__ctx_type_7 &_output_){
   ...
   _ctx.x = 0x0 /* 0.000000 */;
   Demo__ctx_type_2_init(_ctx._inst1fd);
   _output_ = _ctx;
   return ;
}
...
void Demo__ctx_type_9_init(Demo__ctx_type_9 &_output_){
   ...
   Demo__ctx_type_6_init(_ctx._inst45e);
   Demo__ctx_type_2_init(_ctx._inst3fd);
   Demo__ctx_type_8_init(_ctx._inst2c7);
   Demo__ctx_type_8_init(_ctx._inst1c7);
   _output_ = _ctx;
   return ;
}
...
void Demo__ctx_type_12_init(Demo__ctx_type_12 &_output_){
   ...
   Demo__ctx_type_11_init(_ctx.step);
   _ctx.g = 0x0 /* 0.000000 */;
   Demo__ctx_type_3_init(_ctx._inst1f1);
   _output_ = _ctx;
   return ;
...
void Demo__ctx_type_13_init(Demo__ctx_type_13 &_output_){
   ...
   _ctx.write_pos = 0;
   ;
   Demo__ctx_type_1_init(_ctx._inst283);
   Demo__ctx_type_1_init(_ctx._inst183);
   _output_ = _ctx;
   return ;
}

fix16_t Demo_delay(Demo__ctx_type_13 &_ctx, fix16_t x, fix16_t time, fix16_t feedback){
   time = fix_clip(Demo_verysmooth(_ctx._inst183,time),0x0 /* 0.000000 */,0x10000 /* 1.000000 */);
   feedback = fix_clip(Demo_verysmooth(_ctx._inst283,feedback),0x0 /* 0.000000 */,0x10000 /* 1.000000 */);
   fix16_t index_r;
...
void Demo__ctx_type_15_init(Demo__ctx_type_15 &_output_){
   ...
   Demo__ctx_type_8_init(_ctx._inst4c7);
   Demo__ctx_type_5_init(_ctx._inst327);
...
void Demo__ctx_type_16_init(Demo__ctx_type_16 &_output_){
   ...
   Demo__ctx_type_13_init(_ctx._inst56d);
   Demo__ctx_type_8_init(_ctx._inst4c7);
   Demo__ctx_type_12_init(_ctx._inst392);
   Demo__ctx_type_14_init(_ctx._inst245);
   Demo__ctx_type_5_init(_ctx._inst127);
   _output_ = _ctx;
   return ;
}
